...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How LOUDMOUF™ collects, uses and protects your personal information under POPIA." },
      { property: "og:title", content: "Privacy Policy — LOUDMOUF™" },
      { property: "og:description", content: "LOUDMOUF™ privacy practices under South African POPIA." },
    ],
  }),
  component: () => (
    <SiteShell title="Privacy Policy" kicker="Legal">
      ...
      <p>
        This Privacy Policy explains how Gravitas Industries (Pty) Ltd (CK No: 2024/596436/07), trading as LOUDPACK™
        ("we", "us", "our"), the owner of the LOUDMOUF™ trademark, collects, uses, stores and protects your personal
        information when you visit <a href="https://loudmouf.co.za">loudmouf.co.za</a> or purchase LOUDMOUF™ products.
      ...
      <ul>
        ...
        <li>Order history, payment confirmations (payment card details are processed by Shopify Payments / third-party providers, not stored by us).</li>
      ...
      <ul>
        ...
        <li>To send marketing communication (only with your consent — you can unsubscribe at any time).</li>
        <li>To comply with legal, regulatory and age-verification obligations.</li>
      </ul>

      <h2>3. Sharing</h2>
      <p>
        We share personal information only with trusted operators required to run our business: Shopify (e-commerce &
        checkout), The Courier Guy (delivery), payment processors, and email/analytics providers. We do not sell your
        data.
      </p>

      <h2>4. Cookies</h2>
      <p>
        We use cookies for cart persistence, analytics and essential site functionality. You can disable cookies in
