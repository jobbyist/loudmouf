...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Delegate your personal cultivation rights to our horticulturists. Private members-only lifestyle club. THC-infused pouches prepared from your delegated cultivation share." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "LOUDMOUF" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@loudmouf" },
      { name: "twitter:title", content: "LOUDMOUF™ — Private Members-Only Lifestyle Club" },
      { name: "twitter:description", content: "Delegate your personal cultivation rights to our horticulturists. Private members-only lifestyle club." },
