...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with the LOUDMOUF™ team — email, WhatsApp and support hours." },
  ...
  component: () => (
    <SiteShell title="Get in Touch" kicker="Contact">
      <p>
        Questions about a drop, wholesale, media or an existing order? The LOUDMOUF™ team is a message away — usually
        replying within a few hours during business days.
      </p>

      <div className="not-prose mt-10 grid gap-4 sm:grid-cols-2">
        <a href="mailto:hi@loudmouf.co.za" className="glass rounded-2xl p-6 hover:border-loud-yellow/40 transition">
        ...
        <a href="https://wa.me/27680200749" className="glass rounded-2xl p-6 hover:border-loud-yellow/40 transition">
      ...
      <h2>Support Hours</h2>
      <p>Mon – Fri · 09:00 – 17:00 SAST. WhatsApp queries outside these hours are answered the next business day.</p>

      <h2>Wholesale & Media</h2>
      <p>Email <a href="mailto:hi@loudmouf.co.za">hi@loudmouf.co.za</a> with "Wholesale" or "Media" in the subject line.</p>
    </SiteShell>
  ),
});
