...
export function SiteShell({ children, title, kicker }: { children: ReactNode; title: string; kicker?: string }) {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Nav />
      <main className="pt-40 pb-24">
        <div className="mx-auto max-w-4xl px-6">
          {kicker && <p className="text-xs uppercase tracking-[0.3em] text-loud-yellow">{kicker}</p>}
